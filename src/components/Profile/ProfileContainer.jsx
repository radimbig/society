...
class ProfileClass extends React.Component {
  ...
  render() {
    ...
    if (this.props.currentUser.id === this.props.profile.userId) {
      you = true;
    } else {
      you = false;
    }
    ...
    if (this.props.profile.fullName === undefined) {
      ...
      return (
        <div
          style={
            this.props.currentUser.theme
              ? { backgroundColor: "#002329", color: "white" }
