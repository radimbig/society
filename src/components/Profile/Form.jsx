      ...
      <form onSubmit={formik.handleSubmit}>
        <div style={style}>
          <Input
            style={
              props.owner.theme
                ? { backgroundColor: "#1f1f1f", color: "whitesmoke" }
                : {}
            }
        ...
        <div style={style}>
          <Input
            ...
            status={
              props.errorMes.includes("Invalid url format (Contacts->Github)")
                ? "error"
                : null
            }
        ...
        <div style={style}>
          <Input
            ...
            status={
              props.errorMes.includes(
                "Invalid url format (Contacts->Instagram)"
              )
                ? "error"
                : null
            }
        ...
        <div style={style}>
          <Input
            ...
            status={
              props.errorMes.includes("Invalid url format (Contacts->Facebook)")
                ? "error"
                : null
            }
